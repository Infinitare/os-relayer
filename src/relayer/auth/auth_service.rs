...
use crate::relayer::auth::auth_challenges::{AuthChallenge, AuthChallenges};
use crate::relayer::auth::auth_interceptor::{Claims, DeSerClaims};
...
const ACCESS_TOKEN_TTL: StdDuration = StdDuration::from_secs(1_800);
const REFRESH_TOKEN_TTL: StdDuration = StdDuration::from_secs(180_000);
const CHALLENGE_TTL: StdDuration = StdDuration::from_secs(1_800);
const CHALLENGE_EXPIRATION_SLEEP_INTERVAL: StdDuration = StdDuration::from_secs(180);
